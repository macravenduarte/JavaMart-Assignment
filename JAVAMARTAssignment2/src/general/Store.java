...
public class Store 
{
    ...
    public static void main(String[] args) {
        manufacturer.add(new Manufacturing
        ("Manu1", "1234 Double Ave", "A1B2C3", "Bob Smith", 
                "BobSmith@Manu1.com", "Manu1.com", "7051234567"));
        manufacturer.add(new Manufacturing
        ("Manu2", "4321 Float Drive", "B1C2D3", "Jeff Johnson", 
                "JeffJohnson@Manu2.com", "Manu2.com", "7057654321"));
        manufacturer.add(new Manufacturing
        ("Manu3", "4444 Boolean Lane", "C1D2E3", "Ted Williams", 
                "TedWilliams@Manu3.com", "Manu3.com", "7051237654"));
        manufacturer.add(new Manufacturing
        ("Manu4", "0011 Integer Cresent", "D1E2F3", "Jack Brown", 
                "JackBrown@Manu4.com", "Manu4.com", "7057654123"));
        menu();
    }
    // Main Menu
